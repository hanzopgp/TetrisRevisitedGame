...
public class PieceL implements PieceInterface, Serializable {
    ...
    public PieceL(Point centralPiece, String filling, int height, int width, int currentState) {
        ...
        for (int i = 0; i < width; i++) {
            state1.add(new Point(centralPiece.getX() + i, centralPiece.getY() + 1));
            state2.add(new Point(centralPiece.getX() - 1, centralPiece.getY() + i));
            state3.add(new Point(centralPiece.getX() - i, centralPiece.getY() - 1));
            state4.add(new Point(centralPiece.getX() + 1, centralPiece.getY() - i));
        }
    ...
    public PieceInterface move(int x, int y) {
        PieceL newPiece = new PieceL(new Point(this.centralPiece.getX() + x, this.centralPiece.getY() + y), this.getBaseFilling(), this.getHeight(), this.getWidth(), this.getCurrentState());
