...
public class PieceT implements PieceInterface {
    ...
    public PieceT(Piece centralPiece, String filling, int height, int width, int currentState){
    ...
    public PieceInterface move(int x, int y){
        PieceT newPiece = new PieceT(new Piece(this.centralPiece.getX()+x, this.centralPiece.getY()+y),this.getBaseFilling(),this.getHeight(),this.getWidth(),this.getCurrentState());
    ...
    public void constructAllStates(){
        ...
        this.makeState3();
        this.makeState4();
        this.listState = new ArrayList<ArrayList<Piece>>();
    ...
    public void makeState1(){
        this.state1.add(new Piece(centralPiece.getX()-1, centralPiece.getY()));
        this.state1.add(new Piece(centralPiece.getX()+1, centralPiece.getY()));
        this.state1.add(new Piece(centralPiece.getX(), centralPiece.getY()+1));
        this.state1.add(new Piece(centralPiece.getX(), centralPiece.getY()+2));
    }

    //DROITE
    public void makeState2(){
        this.state2.add(new Piece(centralPiece.getX(), centralPiece.getY()-1));
        this.state2.add(new Piece(centralPiece.getX(), centralPiece.getY()+1));
        this.state2.add(new Piece(centralPiece.getX()-1, centralPiece.getY()));
        this.state2.add(new Piece(centralPiece.getX()-2, centralPiece.getY()));
    }

    //BAS
    public void makeState3(){
        this.state3.add(new Piece(centralPiece.getX()+1, centralPiece.getY()));
        this.state3.add(new Piece(centralPiece.getX()-1, centralPiece.getY()));
        this.state3.add(new Piece(centralPiece.getX(), centralPiece.getY()-1));
        this.state3.add(new Piece(centralPiece.getX(), centralPiece.getY()-2));
    }

    //GAUCHE
    public void makeState4(){
        this.state4.add(new Piece(centralPiece.getX(), centralPiece.getY()-1));
        this.state4.add(new Piece(centralPiece.getX(), centralPiece.getY()+1));
        this.state4.add(new Piece(centralPiece.getX()+1, centralPiece.getY()));
        this.state4.add(new Piece(centralPiece.getX()+2, centralPiece.getY()));
    }
    ...
    public void setPieceCentral(Piece centralPiece) {
        this.centralPiece = centralPiece;
    }
    ...
    public void setState1(ArrayList<Piece> state1) {
        this.state1 = state1;
    }

    public void setState2(ArrayList<Piece> state2) {
        this.state2 = state2;
    }

    public void setState3(ArrayList<Piece> state3) {
        this.state3 = state3;
    }

    public void setState4(ArrayList<Piece> state4) {
        this.state4 = state4;
    }
    ...
    public void setCurrentPiece(ArrayList<Piece> currentPiece) {
